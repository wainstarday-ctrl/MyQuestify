...
(function (global) {
  ...
  function status() {
    return {
      ...
      //
      // Проверяется наличие плагина, а не выбранный режим: режим
      // выставляется в init(), а спросить состояние могут раньше — и до
      // сих пор в этот миг любое устройство выглядело настольным.
      shell: !!plugin()
    };
  }
