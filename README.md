...
Языковая модель в мобильную версию не входит — полтора миллиарда параметров
занимают около гигабайта только под веса. Вместо генерации используется тот
же набор заготовленных фраз, что и в настольной версии при их отсутствии.
