...
**Версия для Android — экспериментальная.** Она проверена на ограниченном
числе устройств, и часть возможностей там устроена иначе: напоминания
доставляются системой, а не встроенным планировщиком, поворот предметов в
сценах выполняется экранными кнопками. Основная платформа — настольная.
