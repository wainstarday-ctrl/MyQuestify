...
const LIMITS = [
  {
    ...
    // в установившейся грозе их почти не остаётся.
    //
    // Предел с запасом: сцена строится случайно, и замеры по двадцати пяти
    // прогонам легли между 2.08 и 2.63. Граница в 3 прошла бы все, но
    // слишком близко — стенд начал бы падать через раз без всякой причины,
    // а такая проверка хуже отсутствующей. При возврате к построению
    // градиента в цикле счёт уходит за сорок, и шестёрка ловит это с тем
    // же успехом.
    limit: 6
  },
  {
